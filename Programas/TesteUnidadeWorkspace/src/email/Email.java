...
public interface Email 
{
	 ...
	 * - a e b não podem ser vazios e só podem conter letras minúsculas 
	 * ou dígitos e os símbolos ponto (.), hífen (-) e underscore (_), 
	 * mas não podem começar e nem terminar com estes símbolos;
	 * - .c não pode ser vazio e só podem conter duas ou três letras minúsculas;
	 * - .d pode ser vazio e só podem conter duas letras minúsculas; 
	 */
